...
<p>But don’t worry! You can use the following button to reset your password:<br><br>
                ...
                <br>
             <p> If you don’t use this link within 3 hours, it will expire. To get a new password reset link, visit<a href="http://localhost:4200/account/register">click here</a></p> </p> 
