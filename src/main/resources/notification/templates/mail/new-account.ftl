...
<body style="margin: 0; padding: 0;">
    ...
    <table align="center"
        ...
        <tr> <td align="center"><b>Amirutham Account Creation!</b></td></tr>
        <tr>
            <td style="padding: 0px 20px 0px 20px;">
              <p><b>Hello ${name},</b></p>

                <p> Thanks for creating an account on Amirutham E-portal!</p> 
<p>You can access your account area to view your orders and change your password here:<br><br>

                
                    <span style="float:center;">
                        <button><a style=color:#285F44;text-decoration:none;
                               href="${homeUrl}"
                               target=_blank><b>&nbsp;Click Me &nbsp;</b></a>
                    </span>
